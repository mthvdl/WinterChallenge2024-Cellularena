...
from games.cellularena.game.grid import Grid, Protein
from games.cellularena.game.organ import OrganType
from games.cellularena.game.replay_loader import load_replay
...
def test_replay_step():
    ...
    from games.cellularena.game.coord import ADJACENCY
    target_p0 = None
    for d in ADJACENCY:
        t = pos.add(d)
        tile = grid.get(t)
